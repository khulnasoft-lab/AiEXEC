...
from aiexec.custom.utils import abuild_custom_components, create_component_template
...
async def import_aiexec_components():
    ...
    Scans the `aiexec.components` package and its submodules in parallel, instantiates classes that are subclasses
    ...
    modules_dict = {}
    try:
        import aiexec.components as components_pkg
    except ImportError as e:
        logger.error(f"Failed to import aiexec.components package: {e}", exc_info=True)
