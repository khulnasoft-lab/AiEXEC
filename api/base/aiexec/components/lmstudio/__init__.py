...
if TYPE_CHECKING:
    from aiexec.components.lmstudio.lmstudioembeddings import LMStudioEmbeddingsComponent
    from aiexec.components.lmstudio.lmstudiomodel import LMStudioModelComponent
