...
if TYPE_CHECKING:
    from aiexec.components.embeddings.similarity import EmbeddingSimilarityComponent
    from aiexec.components.embeddings.text_embedder import TextEmbedderComponent
