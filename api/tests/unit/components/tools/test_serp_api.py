...
from aiexec.components.serpapi.serp import SerpComponent
...
@patch("aiexec.components.serpapi.serp.SerpAPIWrapper")
...
def test_error_handling():
    ...
    with patch("aiexec.components.serpapi.serp.SerpAPIWrapper") as mock_serpapi:
        mock_instance = MagicMock()
