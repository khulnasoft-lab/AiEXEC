...
class TestImportUtils:
    ...
    def test_import_mod_with_module_name(self):
        ...
        result = import_mod("OpenAIModelComponent", "openai_chat_model", "aiexec.components.openai")
    ...
    def test_import_mod_module_not_found(self):
        ...
        with pytest.raises(ImportError, match="not found"):
            import_mod("NonExistentComponent", "nonexistent_module", "aiexec.components.openai")

    def test_import_mod_attribute_not_found(self):
        """Test error handling when attribute doesn't exist in module."""
        with pytest.raises(AttributeError):
            import_mod("NonExistentComponent", "openai_chat_model", "aiexec.components.openai")
...
class TestComponentDynamicImports:
    ...
    def test_category_module_dynamic_import(self):
        ...
        import aiexec.components.openai as openai_components
    ...
    def test_multiple_category_modules(self):
        ...
        import aiexec.components.anthropic as anthropic_components
        import aiexec.components.data as data_components
    ...
    def test_backward_compatibility(self):
        ...
        from aiexec.components.agents import AgentComponent
        from aiexec.components.data import APIRequestComponent
        from aiexec.components.openai import OpenAIModelComponent
    ...
    def test_component_instantiation(self):
        ...
        from aiexec.components import helpers
    ...
    def test_import_error_handling(self):
        ...
        import aiexec.components.notdiamond as notdiamond_components

        # Patch the import_mod function directly
        with patch("aiexec.components.notdiamond.import_mod") as mock_import_mod:
    ...
    def test_type_checking_imports(self):
        ...
        import aiexec.components.searchapi as searchapi_components
...
class TestPerformanceCharacteristics:
    ...
    def test_lazy_loading_performance(self):
        ...
        from aiexec.components import vectorstores
    ...
    def test_caching_behavior(self):
        ...
        from aiexec.components import models
    ...
    def test_memory_usage_multiple_accesses(self):
        ...
        from aiexec.components import processing
...
class TestSpecialCases:
    ...
    def test_platform_specific_components(self):
        ...
        import aiexec.components.nvidia as nvidia_components
