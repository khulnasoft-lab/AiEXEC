...
import pytest
from aiexec.components.data.kb_retrieval import KBRetrievalComponent
...
class TestKBRetrievalComponent(ComponentTestBaseWithoutClient):
    ...
    def mock_knowledge_base_path(self, tmp_path):
        ...
        with patch("aiexec.components.data.kb_retrieval.KNOWLEDGE_BASES_ROOT_PATH", tmp_path):
            yield
    ...
    @patch("aiexec.components.data.kb_retrieval.Path.exists")
    ...
    def test_get_kb_metadata_success(self, component_class, default_kwargs):
        ...
        with patch("aiexec.components.data.kb_retrieval.decrypt_api_key") as mock_decrypt:
