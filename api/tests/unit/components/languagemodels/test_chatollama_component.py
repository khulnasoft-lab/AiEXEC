...
import pytest
from aiexec.components.ollama.ollama import ChatOllamaComponent
...
class TestChatOllamaComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("aiexec.components.ollama.ollama.ChatOllama")
    ...
    @pytest.mark.asyncio
    @patch("aiexec.components.ollama.ollama.httpx.AsyncClient.post")
    @patch("aiexec.components.ollama.ollama.httpx.AsyncClient.get")
