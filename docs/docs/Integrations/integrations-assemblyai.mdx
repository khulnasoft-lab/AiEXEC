...
1. Build the flow manually or import a pre-build JSON file:
    ...
    * Recommended: [Download the AssemblyAI Transcription and Speech AI flow JSON](./AssemblyAI_Flow.json), and then [import the flow](/concepts-flows-import) into Aiexec.
