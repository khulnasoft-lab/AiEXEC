---
title: Integrate NVIDIA G-Assist with Aiexec
slug: /integrations-nvidia-g-assist
---

:::important
The **NVIDIA G-Assist** component is available only for Aiexec users with NVIDIA GPUs on Windows systems.
:::
...
* NVIDIA GPU
* `gassist.rise` package installed. This package is included in your [Aiexec installation](/get-started-installation).
