...
For the most accurate and up-to-date list of bundles and components for your version of Aiexec, check the **Components** menu in Aiexec.

If you can't find a component that you used in an earlier version of Aiexec, it may have been removed or marked as a [legacy component](#legacy-components).
:::

Aiexec offers core components in addition to third-party, provider-specific bundles.
