...
For template formatting examples, see [`/starter_projects`](https://github.com/aiexec-ai/aiexec/tree/main/api/base/aiexec/initial_setup/starter_projects) in the Aiexec repository.
...
For more information, see the Aiexec repository's [template categories](https://github.com/aiexec-ai/aiexec/blob/main/web/src/modals/templatesModal/index.tsx#L27-L57).