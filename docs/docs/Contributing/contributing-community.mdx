...
If you like Aiexec, you can star the [Aiexec GitHub repository](https://github.com/aiexec-ai/aiexec).
...
You can watch the [Aiexec GitHub repository](https://github.com/aiexec-ai/aiexec) to get notified about new releases and other repository activity.
