...
New components are added as objects of the [`Component`](https://github.com/aiexec-ai/aiexec/blob/main/api/base/aiexec/custom/custom_component/component.py) class.
...
2. Write your processor as an object of the [`Component`](https://github.com/aiexec-ai/aiexec/blob/main/api/base/aiexec/custom/custom_component/component.py) class. You'll create a new class, `DataFrameProcessor`, that will inherit from `Component` and override the base class's methods.
...
You can view the [/data/__init__.py](https://github.com/aiexec-ai/aiexec/blob/dev/api/base/aiexec/components/data/__init__.py) in the Aiexec repository.
