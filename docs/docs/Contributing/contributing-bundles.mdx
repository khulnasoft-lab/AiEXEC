...
You can view the [components folder](https://github.com/aiexec-ai/aiexec/tree/main/api/base/aiexec/components) in the Aiexec repository.
...
For an example of adding multiple components in a bundle, see the [Notion](https://github.com/aiexec-ai/aiexec/tree/main/api/base/aiexec/components/Notion) bundle.
...
You can view the [icons folder](https://github.com/aiexec-ai/aiexec/tree/main/web/src/icons) in the Aiexec repository.
...
You can view the [lazyIconImports.ts](https://github.com/aiexec-ai/aiexec/blob/main/web/src/icons/lazyIconImports.ts) in the Aiexec repository.
...
You can view the [SIDEBAR_BUNDLES array](https://github.com/aiexec-ai/aiexec/blob/main/web/src/utils/styleUtils.ts#L231) in the Aiexec repository.\
