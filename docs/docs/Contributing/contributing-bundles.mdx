...
You can view the [components folder](https://github.com/aiexec-ai/aiexec/tree/main/src/backend/base/aiexec/components) in the Aiexec repository.
...
You can view the [icons folder](https://github.com/aiexec-ai/aiexec/tree/main/src/frontend/src/icons) in the Aiexec repository.
...
You can view the [lazyIconImports.ts](https://github.com/aiexec-ai/aiexec/blob/main/src/frontend/src/icons/lazyIconImports.ts) in the Aiexec repository.
...
You can view the [SIDEBAR_BUNDLES array](https://github.com/aiexec-ai/aiexec/blob/main/src/frontend/src/utils/styleUtils.ts#L231) in the Aiexec repository.\
