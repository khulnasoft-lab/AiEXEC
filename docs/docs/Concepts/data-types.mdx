...
The schema is defined in [`data.py`](https://github.com/khulnasoft-lab/aiexec/blob/main/api/base/aiexec/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/khulnasoft-lab/aiexec/blob/main/api/base/aiexec/schema/dataframe.py).
...
The `Message` schema is defined in [`message.py`](https://github.com/khulnasoft-lab/aiexec/blob/main/api/base/aiexec/schema/message.py).
Some `Message` attributes have their own schema definitions, such as [`content_block.py`](https://github.com/khulnasoft-lab/aiexec/blob/main/api/base/aiexec/schema/content_block.py).
