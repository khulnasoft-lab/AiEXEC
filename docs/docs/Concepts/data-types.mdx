...
The schema is defined in [`data.py`](https://github.com/aiexec-ai/aiexec/blob/main/src/backend/base/aiexec/schema/data.py).
...
A `Data` object stores key-value pairs within the `.data` attribute, where each key is a field name and its value can be any supported data type. `text_key` tells Aiexec which key in the data dictionary is the primary text value for that object.
...
The schema is defined in [`dataframe.py`](https://github.com/aiexec-ai/aiexec/blob/main/src/backend/base/aiexec/schema/dataframe.py).
...
The `Message` schema is defined in [`message.py`](https://github.com/aiexec-ai/aiexec/blob/main/src/backend/base/aiexec/schema/message.py).
Some `Message` attributes have their own schema definitions, such as [`content_block.py`](https://github.com/aiexec-ai/aiexec/blob/main/src/backend/base/aiexec/schema/content_block.py).
