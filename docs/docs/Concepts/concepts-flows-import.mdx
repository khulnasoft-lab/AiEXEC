...
For an example Aiexec JSON file, examine the [Basic Prompting.json](https://github.com/khulnasoft-lab/aiexec/blob/main/api/base/aiexec/initial_setup/starter_projects/Basic%20Prompting.json) file in the Aiexec repository.
