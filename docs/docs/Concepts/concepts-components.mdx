...
For example, the [**Recursive Character Text Splitter** component](https://github.com/khulnasoft-lab/aiexec/blob/main/api/base/aiexec/components/langchain_utilities/recursive_character.py) is a child of the [`LCTextSplitterComponent`](https://github.com/khulnasoft-lab/aiexec/blob/main/api/base/aiexec/base/textsplitters/model.py) class.
